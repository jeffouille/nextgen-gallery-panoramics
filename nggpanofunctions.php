...
/**
 * nggpanoPanoramic() - show a single pano based on the id
 * 
 * @access public 
 ...
 * @return the content
 */
function nggpanoPanoramicOld($imageID, $width = '100%', $height = '100%', $float = '' , $template = '', $caption = '', $link = '', $captionmode = '', $mapwidth = 250, $mapheight = 250, $mapzoom = 10, $maptype = 'HYBRID') {
    global $post;
    ...
    if ($picture == null)
        return __('[panoramic not found]','nggpano');
...
//    $pano->description = html_entity_decode( stripslashes(nggPanoramic::i18n($picture->description, 'pano_' . $picture->pid . '_description')) );
    ...
    $pano->classname = 'nggpano-panoramic'. $floatpano;
