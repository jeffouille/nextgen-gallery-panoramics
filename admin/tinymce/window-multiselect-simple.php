...
<body id="shortcode" onload="tinyMCEPopup.executeOnLoad('nggpanoinit();');document.body.style.display='';" style="display: none">
    <form name="NGGPano" action="#">
        <div class="tabs">
            <ul>
                <li id="panoramic_tab" class="current"><span><a href="javascript:mcTabs.displayTab('panoramic_tab','panoramic_panel');" onmousedown="return false;"><?php _e('Picture', 'nggpano'); ?></a></span></li>
            ...
            <div id="panoramic_panel" class="panel current">
                ...
                <table border="0" cellpadding="4" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <label for="image-align-none"><input name="panoAlign" type="radio" id="image-align-none" value="none" <?php checked('none', $align); ?> /><?php _e('None','nggallery'); ?></label>
                            <label for="image-align-left"><input name="panoAlign" type="radio" id="image-align-left" value="left" <?php checked('left', $align); ?> /><?php _e('Left','nggallery'); ?></label>
                            <label for="image-align-center"><input name="panoAlign" type="radio" id="image-align-center" value="center" <?php checked('center', $align); ?> /><?php _e('Center','nggallery'); ?></label>
                            <label for="image-align-right"><input name="panoAlign" type="radio" id="image-align-right" value="right" <?php checked('right', $align); ?> /><?php _e('Right','nggallery'); ?></label>
                        </td>
                    </tr>
                    <!-- Legend mode -->
                    <tr>
            ...
            <div id="gallery_panel" class="panel">
                ...
                <table border="0" cellpadding="4" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <label><input name="galleryShortcodetype" type="radio" value="panoramicgallery" checked="checked" /> <?php _e('Gallery of Panoramic', 'nggpano');?> [panoramicgallery]</label><br />
                            <label><input name="galleryShortcodetype" type="radio" value="panoramicgallerywithmap" /> <?php _e('Gallery of Panoramic with map','nggpano') ?> [panoramicgallerywithmap]</label><br />
                        </td>
                    </tr>
                    <!-- Dimensions (Width x Height) -->
                    ...
                    <tr>
                        <td nowrap="nowrap" valign="middle"><?php _e('Alignment','nggallery') ?></td>
                        <td>
                            <label for="gallery-align-none"><input name="galleryAlign" type="radio" id="gallery-align-none" value="none" <?php checked('none', $align); ?> /><?php _e('None','nggallery'); ?></label>
                            <label for="gallery-align-left"><input name="galleryAlign" type="radio" id="gallery-align-left" value="left" <?php checked('left', $align); ?> /><?php _e('Left','nggallery'); ?></label>
                            <label for="gallery-align-center"><input name="galleryAlign" type="radio" id="gallery-align-center" value="center" <?php checked('center', $align); ?> /><?php _e('Center','nggallery'); ?></label>
                            <label for="gallery-align-right"><input name="galleryAlign" type="radio" id="gallery-align-right" value="right" <?php checked('right', $align); ?> /><?php _e('Right','nggallery'); ?></label>
                        </td>
                    </tr>

                    <!-- Map Dimension -->
                    <tr class="gallery_shortcode_options panoramicgallerywithmap">
                        <td nowrap="nowrap" valign="middle"><?php _e("Map", 'nggpano'); ?></td>
                        <td>
                            <table>
                                <tr>
                    ...
                    <!-- Links to show -->
                    <tr valign="top" class="gallery_shortcode_options panoramicgallerywithmap">
                        <td nowrap="nowrap" valign="top"><?php _e('Links to show','nggpano') ?></td>
                        <td>
